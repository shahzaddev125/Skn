...
$codes = array(
    ...
    array( 'code' => 'online_meeting_password',  'description' =>  __( 'online meeting password', 'bookly' ) ),
    array( 'code' => 'online_meeting_start_url', 'description' => __( 'online meeting start URL', 'bookly' ) ),
    array( 'code' => 'online_meeting_url', 'description' => __( 'online meeting URL', 'bookly' ) ),
