    ...
    <?php if ( Lib\Config::showNotes() ): ?>
        <div class="bookly-box">
            <div class="bookly-form-group">
                ...
                <div>
                    <textarea class="bookly-js-user-notes" placeholder="Please Include any notes or requests for your provider in advance of your appointment." rows="3"><?php echo esc_html( $userData->getNotes() ) ?></textarea>
                </div>
            </div>
        </div>
    <?php endif ?>
...
<div class="bookly-box bookly-nav-steps">
    ...
    <div class="inform-text">
    	<p>You'll be redirected to our payment page</p>
    </div>
        <button id="nex-btn-book" class="bookly-next-step bookly-js-next-step bookly-btn ladda-button" data-style="zoom-in" data-spinner-size="40">
