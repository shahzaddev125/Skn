...
jQuery( document ).ready(function() {
	...
	jQuery(".page-id-15 .bookly-js-select-category option[value=11]").hide();
	jQuery(".page-id-15 .bookly-js-select-service option[value=4]").hide();
	jQuery(".page-id-15 .bookly-js-select-service option[value=86]").hide();
	jQuery(".page-id-15 .bookly-js-select-service option[value=87]").hide();
	jQuery(".page-id-15 .bookly-js-select-service option[value=88]").hide();
	jQuery(".page-id-60 .bookly-js-select-service option").hide();
	
	jQuery(".page-id-60 .bookly-js-select-service option[value=16],.page-id-60 .bookly-js-select-service option[value=17],.page-id-60 .bookly-js-select-service option[value=18],.page-id-60 .bookly-js-select-service option[value=19],.page-id-60 .bookly-js-select-service option[value=20],.page-id-60 .bookly-js-select-service option[value=21]").show();
		jQuery(".page-id-100 .bookly-js-select-service option").hide();
		jQuery(".page-id-100 .bookly-js-select-service option[value=36],.page-id-100 .bookly-js-select-service option[value=37],.page-id-100 .bookly-js-select-service option[value=38],.page-id-100 .bookly-js-select-service option[value=39]").show();
	}, 500); 
